...
from eblogger.activities import views as activities_views
from eblogger.authentication import views as bootcamp_auth_views
from eblogger.core import views as core_views
from eblogger.search import views as search_views
...
urlpatterns = [
    ...
    url(r'^feeds/', include('eblogger.feeds.urls')),
    url(r'^questions/', include('eblogger.questions.urls')),
    url(r'^articles/', include('eblogger.articles.urls')),
    url(r'^messages/', include('eblogger.messenger.urls')),
